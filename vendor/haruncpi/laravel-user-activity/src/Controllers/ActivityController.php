...
class ActivityController extends Controller
{
    ...
    public function getIndex(Request $request)
    {
        ...
        $exclude = ['failed_jobs', 'password_resets', 'migrations', 'logs','basic_information','company_pictures','contact_us','education_details','oauth_access_tokens','oauth_auth_codes','oauth_clients','oauth_personal_access_clients','oauth_refresh_tokens','password_resets','recommendation_data','regions','roles','skill_knowledge','user_recommendation','work_experience'];
