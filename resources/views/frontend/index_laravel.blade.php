...
<!-- Main Page -- Meta Tags -->
@section('meta_tags')
<title>Preveri Podjetje - Anonimno oceni zaposlitev</title>
    ...
    <div class="card text-white">
        ...
        <div class="card-img-overlay">
            <div class="container">
                ...
                <h1 class="card-text">Anonimno oceni zaposlitev / Preveri, kaj pravijo zaposleni

                    <!-- Search Companies Area -->
                    {{ Form::open(['route' => 'search_company', 'method' => 'POST','id'=>'filter_company_data_form']) }}

                    <div class="input-group">
                        <input name="title" placeholder="Primer: mercator" type="text" class="form-control noEnterSubmit" aria-invalid="false" autocomplete="off" required>
                ...
                <div class="card card-body">
                    ...
                    <div class="review_detail">
                        ...
                        <div class="dv-star-rating" style="display: inline-block; position: relative;">
                            @for($i=1; $i<=$ratingcount; $i++) @if($random_selected_company->rating < $i) <label class="dv-star-rating-star dv-star-rating-full-star" style="float: left; cursor: pointer; color: rgb(51,51,51);">
            ...
            <div class="col-sm-4">
                <div class="card card-body">
                    ...
                    <div class="review_detail">
                        ...
                        <div class="dv-star-rating" style="display: inline-block; position: relative;">
                            @for($i=1; $i<=$ratingcount; $i++) @if($last_comment->company->rating < $i) <label class="dv-star-rating-star dv-star-rating-full-star" style="float: left; cursor: pointer; color: rgb(51,51,51);">
                                    <i style="font-style: normal;">★</i>
                                    </label>
                                    @else
...
<div class="top_companies">
    <div class="container">
        <h3 class="card-title">Dobro ocenjene zaposlitve</h3>
